// components/ArtBackground.js
import React, { useEffect, useState } from 'react';
import './ArtBackground.css'; 
...
const ArtBackground = ({ children }) => {
  ...
  // Determine the number of images based on window size
  const numberOfImages = window.innerWidth >= 768 ? 10 : 5; // 6 for desktop, 3 for mobile
