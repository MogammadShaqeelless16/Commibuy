...
function AboutPage() {
  return (
    <div className="about-page">
      ...
      <p>
        At Commiploy, we specialize in online transactions, making it easy for you to purchase products from your favorite local businesses without leaving your home. Our platform is designed to promote and support small businesses, providing them with the exposure they need to thrive and succeed.
      </p>
      <p>
